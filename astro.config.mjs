			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'path (Paths)', translations: { tr: 'path (Yollar)' }, slug: 'stdlib-path' },
						{ label: 'utf8 (Text Encoding)', translations: { tr: 'utf8 (Metin Kodlama)' }, slug: 'stdlib-utf8' },
						{ label: 'stdin / stdout / stderr', slug: 'stdlib-io' },
						{ label: 'sys (System)', translations: { tr: 'sys (Sistem)' }, slug: 'stdlib-sys' },
						{ label: 'process (Process Control)', translations: { tr: 'process (Süreç Kontrolü)' }, slug: 'stdlib-process' },
