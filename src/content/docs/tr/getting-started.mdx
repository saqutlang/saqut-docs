...
- Veriyi saklamayı ve adlandırmayı öğrenmek için [değişkenler](/tr/variables/) sayfasına bakın
- Hangi değer türlerinin bulunduğunu keşfetmek için [veri türlerini](/tr/data-types/) inceleyin
